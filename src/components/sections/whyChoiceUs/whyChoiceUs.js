        ...
        <div className='WhyChoiceUs'>
          ...
          <div >
            ...
            <Media queries={GLOBAL_MEDIA_QUERIES}>
              {matches => (
                <React.Fragment>
                  {matches.large && <div style={{ transform: "translateX(-10px)" }}>
                  ...
                  {(matches.medium || matches.small) && <>
                    <div style={{ width:matches.small?380:500 }}>
                      ...
                      <div className='WhyChoiceUs-5div'>
                        ...
                        <div><DialogSelection defaultCursor={true} setIsShadow={setIsShadow} haveShader={isShadow[0]} setSelectedDataId={setSelectedDataId} selectedDataId={selectedDataId} id={0} img={Image1} title="Expertise" /></div>
                        <div><DialogSelection defaultCursor={true} setIsShadow={setIsShadow} haveShader={isShadow[1]} setSelectedDataId={setSelectedDataId} selectedDataId={selectedDataId} id={1} img={Image2} title="Experience" /></div>
                        <div><DialogSelection defaultCursor={true} setIsShadow={setIsShadow} haveShader={isShadow[2]} setSelectedDataId={setSelectedDataId} selectedDataId={selectedDataId} id={2} img={Image3} title="Quality" /></div>
                        <div><DialogSelection defaultCursor={true} setIsShadow={setIsShadow} haveShader={isShadow[3]} setSelectedDataId={setSelectedDataId} selectedDataId={selectedDataId} id={3} img={Image4} title="Agility" /></div>
                        <div><DialogSelection defaultCursor={true} setIsShadow={setIsShadow} haveShader={isShadow[4]} setSelectedDataId={setSelectedDataId} selectedDataId={selectedDataId} id={4} img={Image5} title="Efficiency" /></div>
                      </div>
