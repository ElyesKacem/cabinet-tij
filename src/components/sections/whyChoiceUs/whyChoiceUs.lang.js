...
const texts = {
  en: {
    ...
    here_are: "Here Are A Few Reasons To Trust Us",
    expertise: "Expertise",
    ...
    expertise_pg:
      "Our company provides a large network of over 400 language professionals.",
    experience_pg: "More than 60 Languages translated and interpreted.",
  ...
  fr: {
    ...
    experience_pg: "Plus de 60 langues traduites et interprétées.",
