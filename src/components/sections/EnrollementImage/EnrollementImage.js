  ...
  return (
    ...
    <BackgroundImage img={Background} >
      ...
      <div className='EnrollementImage-content'>
        ...
        <div className='EnrollementImage-paragraph'>We are delighted that you want to become a member of our group
        <br /> To submit your membership application, please fill out the form belowand attach any required documents.</div>
        <br /><br /><br /><br />
