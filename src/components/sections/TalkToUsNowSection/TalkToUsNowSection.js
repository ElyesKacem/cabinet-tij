                                ...
                                <div container>
                                    <div item xs={6}>
                                        <div style={{ width: "100%", display: "flex", flexDirection: "column", alignItems: "center" }}>
                                            ...
                                            <br />
                                            <br />
                                            <div className='getQuoteForm-submit-button' style={{ transform: "translateY(0px)" }}>Submit</div>
                                    ...
                                    <div item xs={6} style={{ transform: "translateY(20px)" }}>
                                        {
                                            matches.small && <div style={{ transform: "scale(0.6)" }}><HoverImage img={Image1} /></div>
                                        }
                                        {
                                            !matches.small && <><br />
                                                <br />
                                                <br /><div><HoverImage img={Image1} />
                                                    <br />
                                                    <br />
                                                    <br />
                                        ...
                                        <div className='TalkToUsNowSection-container'>
                                            ...
                                            <div className='TalkToUsNowSection-subContainer'>
                                                ...
                                                <div style={{ width: 200 }}>1 rue René et Isa Lefèvre </div><div>93450 L'IIe-Saint-Denis</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
